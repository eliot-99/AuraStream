...
export default function WebGLGradient() {
    ...
    return _jsx("div", { ref: mountRef, className: "absolute inset-0 w-full h-full -z-20", style: { filter: 'blur(14px)', transform: 'scale(1.06)' }, "aria-hidden": "true" });
}
