...
`;
const Threads = ({ color = [1, 1, 1], amplitude = 1, distance = 0, enableMouseInteraction = false, className, }) => {
    ...
    useEffect(() => {
        ...
        const program = new Program(gl, {
            ...
            uniforms: {
                iTime: { value: 0 },
                iResolution: {
                    value: { r: gl.canvas.width, g: gl.canvas.height, b: gl.canvas.width / gl.canvas.height },
                },
                uColor: { value: { r: color[0], g: color[1], b: color[2] } },
    ...
    return _jsx("div", { ref: containerRef, className: `threads-container ${className || ''}` });
};
