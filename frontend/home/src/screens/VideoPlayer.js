...
export default function VideoPlayer({ onBack, src }) {
    ...
    return (_jsxs("div", { className: "relative min-h-screen text-white font-montserrat overflow-hidden", children: [_jsx("video", { ref: decoyRef, className: "pointer-events-none fixed inset-0 w-full h-full object-cover filter blur-[50px] scale-[2_1.5] opacity-60 z-0", muted: true, playsInline: true, preload: "auto", "aria-hidden": "true" }), _jsxs("div", { className: "absolute top-4 left-4 right-4 z-[1002] flex items-center justify-between", children: [_jsx("button", { onClick: () => (onBack ? onBack() : window.history.back()), className: "h-10 w-10 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center hover:scale-110 transition", "aria-label": "Back", children: _jsx(Icon.Back, { className: "w-5 h-5" }) }), _jsx("div", { className: "flex items-center gap-2", children: !showDrawer && (_jsx("button", { onClick: () => setShowDrawer(true), "aria-label": "Open Directory", title: "Open Directory", className: "h-10 w-10 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center hover:scale-110 transition", children: _jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", className: "w-5 h-5", children: _jsx("path", { d: "M10 4l2 2h8a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V6a2 2 0 012-2h6z" }) }) })) })] }), _jsxs("main", { className: "relative z-10 min-h-screen w-full p-0", children: [_jsx("div", { className: "absolute inset-0", children: _jsx("div", { className: "absolute inset-0 flex items-center justify-center px-4 pt-6 pb-28", children: _jsx("div", { className: "relative inline-flex rounded-2xl overflow-hidden shadow-2xl max-w-[92vw]", style: { width: box.w || undefined, height: box.h || undefined, boxShadow: `0 0 40px ${bgColor.replace('rgb', 'rgba').replace(')', ', 0.35)')}` }, children: _jsx("video", { ref: videoRef, controls: false, className: `relative z-10 block w-full h-full ${aspect > 1.72 && aspect < 1.82 ? 'object-cover' : 'object-contain'} bg-black`, playsInline: true, preload: "metadata", onPlay: async () => { try {
