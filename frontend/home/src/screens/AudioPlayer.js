...
export default function AudioPlayer({ onBack, src, name }) {
    ...
    return (_jsxs("div", { className: "relative min-h-screen w-full font-montserrat text-white", children: [_jsxs("div", { className: "absolute inset-0 -z-20", children: [_jsx(Lightning, { ref: lightningRef, hue: hue, xOffset: 0, speed: speed, intensity: intensity, size: size, qualityScale: 0.75, horizontal: true }), _jsx("div", { className: "absolute inset-0 backdrop-blur-[40px]" })] }), _jsx("div", { className: "absolute inset-0 -z-10 flex items-center justify-center pointer-events-none", children: _jsxs("div", { className: "relative w-[60vmin] h-[60vmin] max-w-[520px] max-h-[520px] flex items-center justify-center", children: [_jsxs("div", { className: "absolute inset-0 flex items-center justify-center", children: [_jsx("div", { className: "absolute rounded-full", style: {
                            ...
                            }, children: _jsx("img", { src: current?.cover || FALLBACK_COVER, alt: "cover", className: "w-[32vmin] h-[32vmin] max-w-[280px] max-h-[280px] rounded-full object-cover", draggable: false }) })] }) }), _jsxs("div", { className: "absolute top-4 left-4 right-4 z-20 flex items-center justify-between", children: [_jsx("button", { onClick: () => (onBack ? onBack() : window.history.back()), "aria-label": "Back", className: "h-10 w-10 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center hover:scale-110 transition", children: _jsx(Icon.Back, { className: "w-5 h-5" }) }), _jsx("div", { className: "flex items-center gap-2", children: _jsx("button", { onClick: () => { setShowDrawer(true); }, "aria-label": "Open Directory", title: "Open Directory", className: "h-10 w-10 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center hover:scale-110 transition", children: _jsx(Icon.Folder, { className: "w-5 h-5" }) }) })] }), _jsx("div", { className: "absolute top-16 left-0 right-0 z-10 text-center px-6", children: _jsx("div", { className: "inline-block px-4 py-1 text-sm md:text-base text-white/90 backdrop-blur-sm bg-black/20 rounded-full border border-white/10", children: title }) }), _jsxs("div", { className: `fixed top-0 right-0 h-full w-[80%] max-w-[380px] z-30 bg-black/70 backdrop-blur-md border-l border-white/15 transform transition-transform duration-300 ${showDrawer ? 'translate-x-0' : 'translate-x-full'}`, children: [_jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-white/10", children: [_jsx("div", { className: "text-white/90 font-medium", children: "Playlist" }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("button", { onClick: handleDirectory, "aria-label": "Select Directory", title: "Select Directory", className: "h-9 w-9 rounded bg-white/10 border border-white/20 text-white/90 flex items-center justify-center hover:scale-105 transition", children: _jsx(Icon.Folder, { className: "w-4 h-4" }) }), _jsx("button", { onClick: () => setShowDrawer(false), "aria-label": "Close", title: "Close", className: "h-9 w-9 rounded bg-white/10 border border-white/20 text-white/90 flex items-center justify-center hover:scale-105 transition", children: _jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", className: "w-4 h-4", children: _jsx("path", { d: "M6 6l12 12M18 6L6 18", stroke: "currentColor", strokeWidth: "2" }) }) })] })] }), _jsx("div", { className: "overflow-y-auto max-h-[calc(100%-52px)] p-2", children: playlist.length === 0 ? (_jsx("div", { className: "text-white/60 text-sm px-2 py-3", children: "No files loaded. Click the folder icon to choose a directory." })) : (_jsx("ul", { className: "space-y-1", children: playlist.map((t, i) => (_jsx("li", { children: _jsxs("button", { onClick: async () => {
                                        const a = audioRef.current;
                                        setIndex(i);
                                        setShowDrawer(false);
                                        if (a) {
